---
layout: page
title: The WAVE Model: Integrating Welfare, Demand Elasticities, and Global Value Added  
permalink: /wave/
description:
nav: false
display_categories: 
...
w_{(c,s),r} 
= \alpha_r 
+ \sum_{r'} \gamma_{rr'} \ln p_{r'} 
+ \beta_r \ln \left(\frac{X_{(c,s)}}{a(p)} \right)
+ \lambda_r \left[\ln \left(\frac{X_{(c,s)}}{a(p)}\right)\right]^2 .
$$
...
# What We Learn From the Tariff Case  
...
WAVE evaluates outcomes in terms of value added, aligning results with welfare and macroeconomic policy goals. Value added reflects the income generated by labour and capital and corresponds directly to GDP. Tracking changes in VA therefore reveals how shocks reshape economic welfare, income distribution, and fiscal capacity across countries and sectors.

This choice ensures that WAVE's results speak directly to policymakers concerned with inequality, industrial policy, and macroeconomic performance.
